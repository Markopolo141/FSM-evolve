...
"advantage_hetero":np.linspace(1.03,1.03,1),
...
'''settings_coords = {
"PN":np.linspace(0.45,0.45,1),
"NN":np.linspace(0.0,0.0,1),
...
try:
    for settings in tqdm(settings_combinations):
        ...
        for i in range(len(outcomes)):
            ...
            try:
                outer_difference,_ = sim.outer_run(
            ...
            try:
                sim.run(max_inner_iterations=max_inner_iterations,
                max_outer_iterations=max_outer_iterations,
                outer_incorporation_factor=outer_incorporation_factor,
